<?php namespace Markdown
{
	 ...
	 *
	 * @copyright Copyright (c) 2004-2009 Michel Fortin, 2004-2006 John Gruber	 *
	 * @author Michel Fortin [mf] michel.fortin@michelf.com
	...
	class Parser
	{
		 ...
		 *
		 */
		public $nested_brackets_re = NULL;
		 ...
		 *
		 */
		public $nested_url_parenthesis_re = NULL;
		 ...
		 */
		public $empty_element_suffix = self::MARKDOWN_EMPTY_ELEMENT_SUFFIX;


		/**
		 *
		 */
		public $tab_width = self::MARKDOWN_TAB_WIDTH;
		...
		public function __construct() {
			...
			$this->nested_brackets_re = implode('', array(
				str_repeat('(?>[^\[\]]+|\[', $this->nested_brackets_depth),
				str_repeat('\])*', $this->nested_brackets_depth)
			));

			$this->nested_url_parenthesis_re = implode('', array(
		...
		/**
		 * Called after the transformation process to clear memory
		 */
